  ...
  Schema: {
    MTProto: {
      constructors: [{
        ...
        params: [{ name: 'first_msg_id', type: 'long' }, {
          name: 'unique_id',
          type: 'long',
        ...
        params: [{ name: 'bad_msg_id', type: 'long' }, {
          name: 'bad_msg_seqno',
          type: 'int',
        ...
        params: [{ name: 'bad_msg_id', type: 'long' }, {
          name: 'bad_msg_seqno',
          type: 'int',
        }, { name: 'error_code', type: 'int' }, { name: 'new_server_salt', type: 'long' }],
        type: 'BadMsgNotification',
      }, {
        id: '2105940488',
      ...
      methods: [{
        ...
        id: '-1835453025',
        method: 'http_wait',
        params: [{ name: 'max_delay', type: 'int' }, {
          name: 'wait_after',
          type: 'int',
    ...
    API: {
      constructors: [{
        ...
        params: [{ name: 'client_id', type: 'long' }, {
          name: 'phone',
          type: 'string',
        ...
        params: [{ name: 'flags', type: '#' }, { name: 'creator', type: 'flags.0?true' }, {
          ...
          name: 'photo',
          type: 'ChatPhoto',
        }, { name: 'participants_count', type: 'int' }, { name: 'date', type: 'int' }, {
          name: 'version',
          type: 'int',
        ...
        params: [{ name: 'flags', type: '#' }, { name: 'out', type: 'flags.1?true' }, {
          ...
          name: 'silent',
          type: 'flags.13?true',
        }, { name: 'post', type: 'flags.14?true' }, { name: 'id', type: 'int' }, {
          name: 'from_id',
          type: 'flags.8?int',
        ...
        params: [{ name: 'flags', type: '#' }, {
          name: 'show_previews',
          type: 'flags.0?true',
        }, { name: 'silent', type: 'flags.1?true' }, { name: 'mute_until', type: 'int' }, {
          name: 'sound',
          type: 'string',
        }],
        ...
        params: [{ name: 'blocked', type: 'Vector<ContactBlocked>' }, {
          name: 'users',
          type: 'Vector<User>',
        }],
        ...
        params: [{ name: 'user_id', type: 'int' }, {
          name: 'first_name',
          type: 'string',
        }, { name: 'last_name', type: 'string' }, { name: 'username', type: 'string' }],
        type: 'Update',
      }, {
        id: '-1791935732',
        ...
        params: [{ name: 'flags', type: '#' }, { name: 'out', type: 'flags.1?true' }, {
          ...
          name: 'silent',
          type: 'flags.13?true',
        }, { name: 'id', type: 'int' }, { name: 'from_id', type: 'int' }, {
          name: 'chat_id',
          type: 'int',
        }, { name: 'message', type: 'string' }, { name: 'pts', type: 'int' }, {
          name: 'pts_count',
          type: 'int',
        }, { name: 'date', type: 'int' }, {
          name: 'fwd_from',
        ...
        params: [{ name: 'type', type: 'storage.FileType' }, {
          name: 'mtime',
          type: 'int',
        ...
        params: [{ name: 'flags', type: '#' }, { name: 'ipv6', type: 'flags.0?true' }, {
          ...
          name: 'cdn',
          type: 'flags.3?true',
        }, { name: 'static', type: 'flags.4?true' }, { name: 'id', type: 'int' }, {
          name: 'ip_address',
          type: 'string',
        }, { name: 'port', type: 'int' }],
        type: 'DcOption',
        ...
        }, { name: 'caption', type: 'flags.1?string' }, { name: 'ttl_seconds', type: 'flags.2?int' }],
        type: 'MessageMedia',
      }, {
        id: '1928391342',
        ...
        params: [{ name: 'peer', type: 'NotifyPeer' }, {
          name: 'notify_settings',
          type: 'PeerNotifySettings',
        }],
        type: 'Update',
        ...
        params: [{ name: 'flags', type: '#' }, {
          name: 'popup',
          type: 'flags.0?true',
        }, { name: 'inbox_date', type: 'flags.1?int' }, { name: 'type', type: 'string' }, {
          name: 'message',
          type: 'string',
        }, { name: 'media', type: 'MessageMedia' }, { name: 'entities', type: 'Vector<MessageEntity>' }],
        type: 'Update',
      }, {
        id: '-496024847',
        ...
        params: [{ name: 'hash', type: 'long' }, { name: 'flags', type: 'int' }, {
          ...
          name: 'app_version',
          type: 'string',
        }, { name: 'date_created', type: 'int' }, { name: 'date_active', type: 'int' }, {
          name: 'ip',
          type: 'string',
        }, { name: 'country', type: 'string' }, { name: 'region', type: 'string' }],
        type: 'Authorization',
      }, {
        id: '307276766',
        ...
        params: [{ name: 'current_salt', type: 'bytes' }, {
          name: 'new_salt',
          type: 'bytes',
        ...
        params: [{ name: 'flags', type: '#' }, {
          ...
          name: 'public',
          type: 'flags.2?true',
        }, { name: 'megagroup', type: 'flags.3?true' }, { name: 'title', type: 'string' }, {
          name: 'photo',
          type: 'ChatPhoto',
        }, { name: 'participants_count', type: 'int' }, { name: 'participants', type: 'flags.4?Vector<User>' }],
        type: 'ChatInvite',
      }, {
        id: '-123931160',
        ...
        params: [{ name: 'flags', type: '#' }, {
          ...
          name: 'official',
          type: 'flags.2?true',
        }, { name: 'masks', type: 'flags.3?true' }, { name: 'id', type: 'long' }, {
          name: 'access_hash',
          type: 'long',
        ...
        params: [{ name: 'flags', type: '#' }, {
          name: 'broadcast',
          type: 'flags.5?true',
        }, { name: 'megagroup', type: 'flags.8?true' }, { name: 'id', type: 'int' }, {
          name: 'access_hash',
          type: 'long',
        }, { name: 'title', type: 'string' }, { name: 'until_date', type: 'flags.16?int' }],
        type: 'Chat',
      }, {
        id: '2131196633',
        ...
        params: [{ name: 'flags', type: '#' }, {
          ...
          type: 'flags.7?true',
        }, { name: 'hidden_prehistory', type: 'flags.10?true' }, { name: 'id', type: 'int' }, {
          name: 'about',
          type: 'string',
        ...
        params: [{ name: 'url', type: 'string' }, {
          name: 'thumb_url',
          type: 'string',
        }, { name: 'content_url', type: 'string' }, { name: 'content_type', type: 'string' }, {
          name: 'w',
          type: 'int',
        }, { name: 'h', type: 'int' }],
        type: 'FoundGif',
        ...
        params: [{ name: 'flags', type: '#' }, { name: 'id', type: 'string' }, {
          ...
          name: 'content_type',
          type: 'flags.5?string',
        }, { name: 'w', type: 'flags.6?int' }, { name: 'h', type: 'flags.6?int' }, {
          name: 'duration',
          type: 'flags.7?int',
        ...
        }, { name: 'cache_time', type: 'int' }, { name: 'users', type: 'Vector<User>' }],
        ...
        params: [{ name: 'flags', type: '#' }, { name: 'alert', type: 'flags.1?true' }, {
          ...
          name: 'message',
          type: 'flags.0?string',
        }, { name: 'url', type: 'flags.2?string' }, { name: 'cache_time', type: 'int' }],
        ...
        params: [{ name: 'flags', type: '#' }, {
          name: 'geo_point',
          type: 'InputGeoPoint',
        }, { name: 'period', type: 'int' }, { name: 'reply_markup', type: 'flags.2?ReplyMarkup' }],
        type: 'InputBotInlineMessage',
      }, {
        id: '-1431327288',
        ...
        params: [{ name: 'flags', type: '#' }, {
          name: 'geo_point',
          type: 'InputGeoPoint',
        }, { name: 'title', type: 'string' }, { name: 'address', type: 'string' }, {
          name: 'provider',
          type: 'string',
        }, { name: 'venue_id', type: 'string' }, { name: 'reply_markup', type: 'flags.2?ReplyMarkup' }],
        type: 'InputBotInlineMessage',
      }, {
        id: '766443943',
        ...
        params: [{ name: 'category', type: 'TopPeerCategory' }, {
          name: 'count',
          type: 'int',
        ...
        params: [{ name: 'url', type: 'string' }, {
          ...
          name: 'date',
          type: 'int',
        }, { name: 'blocks', type: 'Vector<PageBlock>' }, { name: 'caption', type: 'RichText' }],
        type: 'PageBlock',
      }, {
        id: '145955919',
        ...
        params: [{ name: 'flags', type: '#' }, {
          name: 'need_rating',
          type: 'flags.2?true',
        }, { name: 'need_debug', type: 'flags.3?true' }, { name: 'id', type: 'long' }, {
          name: 'reason',
        ...
        params: [{ name: 'lang_code', type: 'string' }, {
          name: 'from_version',
          type: 'int',
        }, { name: 'version', type: 'int' }, { name: 'strings', type: 'Vector<LangPackString>' }],
        ...
        params: [{ name: 'flags', type: '#' }, {
          ...
          name: 'send_inline',
          type: 'flags.6?true',
        }, { name: 'embed_links', type: 'flags.7?true' }, { name: 'until_date', type: 'int' }],
        ...
        params: [{ name: 'flags', type: '#' }, {
          name: 'can_edit',
          type: 'flags.0?true',
        }, { name: 'user_id', type: 'int' }, { name: 'inviter_id', type: 'int' }, {
          name: 'promoted_by',
          type: 'int',
        }, { name: 'date', type: 'int' }, { name: 'admin_rights', type: 'ChannelAdminRights' }],
        type: 'ChannelParticipant',
      }, {
        id: '573315206',
        ...
        params: [{ name: 'geo_point', type: 'InputGeoPoint' }, { name: 'period', type: 'int' }],
        type: 'InputMedia',
      }, {
        id: '2084316681',
        ...
        params: [{ name: 'media', type: 'InputMedia' }, { name: 'random_id', type: 'long' }],
      ...
      methods: [{
        ...
        params: [{ name: 'token_type', type: 'int' }, {
          name: 'token',
          type: 'string',
        }, { name: 'app_sandbox', type: 'Bool' }, { name: 'other_uids', type: 'Vector<int>' }],
        type: 'Bool',
      }, {
        id: '813089983',
        ...
        params: [{ name: 'peer', type: 'InputPeer' }, {
          ...
          name: 'limit',
          type: 'int',
        }, { name: 'max_id', type: 'int' }, { name: 'min_id', type: 'int' }, { name: 'hash', type: 'int' }],
        type: 'messages.Messages',
      }, {
        id: '60726944',
        ...
        params: [{ name: 'flags', type: '#' }, {
          ...
          name: 'with_my_score',
          type: 'flags.8?true',
        }, { name: 'grouped', type: 'flags.9?true' }, { name: 'from_peer', type: 'InputPeer' }, {
          name: 'id',
          type: 'Vector<int>',
        ...
        params: [{ name: 'emoticon', type: 'string' }, { name: 'hash', type: 'string' }],
        type: 'messages.Stickers',
      }, {
        id: '479598769',
        ...
        params: [{ name: 'bot', type: 'InputUser' }, {
          name: 'peer',
          type: 'InputPeer',
        }, { name: 'random_id', type: 'long' }, { name: 'start_param', type: 'string' }],
        type: 'Updates',
      }, {
        id: '-1877938321',
        ...
        params: [{ name: 'flags', type: '#' }, {
          name: 'broadcast',
          type: 'flags.0?true',
        }, { name: 'megagroup', type: 'flags.1?true' }, { name: 'title', type: 'string' }, {
          name: 'about',
          type: 'string',
        }],
        type: 'Updates',
        ...
        params: [{ name: 'flags', type: '#' }, {
          name: 'allow_flashcall',
          type: 'flags.0?true',
        }, { name: 'hash', type: 'string' }, { name: 'current_number', type: 'flags.0?Bool' }],
        type: 'auth.SentCode',
      }, {
        id: '1596029123',
        ...
        params: [{ name: 'flags', type: '#' }, {
          name: 'edit_message',
          type: 'flags.0?true',
        }, { name: 'force', type: 'flags.1?true' }, { name: 'peer', type: 'InputPeer' }, {
          name: 'id',
          type: 'int',
        }, { name: 'user_id', type: 'InputUser' }, { name: 'score', type: 'int' }],
        type: 'Updates',
      }, {
        id: '363700068',
        ...
        params: [{ name: 'flags', type: '#' }, {
          name: 'success',
          type: 'flags.1?true',
        }, { name: 'query_id', type: 'long' }, { name: 'error', type: 'flags.0?string' }],
        type: 'Bool',
      }, {
        id: '-1680314774',
        ...
        params: [{ name: 'user_id', type: 'InputUser' }, {
          name: 'random_id',
          type: 'int',
        }, { name: 'g_a_hash', type: 'bytes' }, { name: 'protocol', type: 'PhoneCallProtocol' }],
        type: 'phone.PhoneCall',
      }, {
        id: '1003664544',
        ...
        params: [{ name: 'peer', type: 'InputPhoneCall' }, {
          name: 'duration',
          type: 'int',
        }, { name: 'reason', type: 'PhoneCallDiscardReason' }, { name: 'connection_id', type: 'long' }],
        type: 'Updates',
      }, {
        id: '475228724',
        ...
        }, { name: 'max_id', type: 'long' }, { name: 'min_id', type: 'long' }, {
          name: 'limit',
          type: 'int',
        }],
        type: 'channels.AdminLogResults',
